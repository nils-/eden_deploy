...
# Script to a add a Test site to a server configured with CherokeePostGIS

echo -e "What name should we use for the test site? : \c "
read sitename

ln -s /home/web2py /home/prod
ln -s /home/prod ~
...
git clone git://github.com/web2py/web2py.git test
ln -s /home/test ~
